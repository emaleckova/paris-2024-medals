...
girafe(ggobj = p_world, width_svg = 11, height_svg = 5) |> 
  girafe_options(
    opts_tooltip(
      use_fill = FALSE,
      css = "font-family:gowun-dodum;background-color:#ffffff;color:black;padding:5px;border-radius:5px;"
    ),
    opts_toolbar(position = "bottom", hidden = c("saveaspng", "zoom_onoff"), fixed = TRUE),
    opts_zoom(min = 0.8, max = 2),
...
girafe(ggobj = p_eu, width_svg = 11, height_svg = 5) |> 
  girafe_options(
    opts_tooltip(
      use_fill = FALSE,
      css = "font-family:gowun-dodum;background-color:#ffffff;color:black;padding:5px;border-radius:5px;"
