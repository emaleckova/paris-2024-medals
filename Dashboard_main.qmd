...
gender_plot_title <- paste0("**Participations of <span style='color:", col_genders[1], "'>male</span> and ", "<span style='color:", col_genders[2], "'>female</span> athletes in Summer Olympics: 1900-2024**")
...
p_genders <- female_dat |> 
  ...
  scale_colour_manual(values = col_genders) +
...
# Top medallists {orientation="rows"}
