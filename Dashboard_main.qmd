...
<!-- Try removing team sports from the athlete counts by gender. -->
```{r}
#| eval: false

teams_dat <- read.delim("data/teams.csv", sep = ",", header = T)

library(splitstackshape)

teams_dat <- cSplit(teams_dat, splitCols = "athletes", sep = ",", direction = "long")

teams_by_gender <- teams_dat |> 
...
n_men - teams_by_gender[teams_by_gender$team_gender == "M", ]$n_athletes
n_women - teams_by_gender[teams_by_gender$team_gender == "W", ]$n_athletes
```
...
# Torch relay {orientation="columns"}
...
I made this website to practice use of Quarto dashboards and its deployment to public. I aimed to use packages and visualizations I have not used so far for work.
